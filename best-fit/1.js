...
submitBtn.addEventListener("click", (event) => {
  ...
  dialogue.innerHTML = "Nice job!  Below you will see an equation reprenting your line.  But is this a good representation of the data?  Fortunately, statisticians have a tried and tue way of creating a line of 'Best fit' for this sort of data.";
  prompt.innerHTML = "Click 'Next' to see how your line compares to this myseterious (for now!) 'Best fit' line";
});
